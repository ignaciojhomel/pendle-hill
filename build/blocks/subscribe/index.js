...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/subscribe/editor.scss");
...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Title Level', 'subscribe'),
    value: titleLevel,
    options: [{
      label: 'H1',
      value: 'h1'
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Text Level', 'subscribe'),
    value: textLevel,
    options: [{
      label: 'H1',
      value: 'h1'
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Content Image Settings', 'subscribe')
    ...
    })) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select Background Image', 'subscribe'))
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Remove Background Image', 'subscribe'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.BaseControl, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Form Embed Code', 'subscribe'),
    value: formEmbed,
    onChange: value => setAttributes({
      formEmbed: value
    })
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Title', 'subscribe'),
    value: title,
    onChange: value => setAttributes({
      title: value
    })
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Text', 'subscribe'),
    value: text,
    onChange: value => setAttributes({
      text: value
    })
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)((_option$title = option.title) !== null && _option$title !== void 0 ? _option$title : 'Social Icons', 'subscribe'),
      initialOpen: false
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.BaseControl, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUpload, {
      onSelect: media => {
        const newIcons = [...socialIcons];
        newIcons[index].image = {
          url: media.url,
          id: media.id,
          alt: media.alt
        };
      ...
      })) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select Icon', 'subscribe'))
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Remove Icon', 'subscribe')))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Social Icons Title', 'subscribe'),
      value: option.title,
      onChange: value => {
        const newIcons = [...socialIcons];
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Social Icons Link', 'subscribe'),
      value: option.link,
      onChange: value => {
        const newIcons = [...socialIcons];
      ...
      isDestructive: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Remove Social Icons', 'subscribe'))));
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.BaseControl, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    onClick: () => {
      const newIcons = [...socialIcons, {}];
      setAttributes({
    ...
    isPrimary: true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Add Social Icons', 'subscribe'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.BaseControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Primary Button', 'subscribe')
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('URL', 'subscribe'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Primary Button Target', 'subscribe'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('SVG Icon (Inline or URL)', 'subscribe'),
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enter the SVG inline code or the URL to an external SVG file.', 'subscribe')
    ...
    render: ({
      ...
      onClick: open,
      isPrimary: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Upload SVG Icon', 'subscribe'))
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.BaseControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Secondary Button', 'subscribe')
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Text', 'subscribe'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Secondary Button Target', 'subscribe'),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Block ID', 'subscribe'),
    value: blockID,
    onChange: value => setAttributes({
      blockID: value
    })
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `subscribe__overlay`
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `container`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `subscribe__text-wrapper`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `subscribe__text-wrapper-inner`
    ...
    className: "subscribe__text-buttons"
    ...
    alt: "Button Icon",
    className: "two-col-text-buttons__icon"
  }), secondaryButton.text)), socialIcons && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "icons-wrapper"
  }, socialIcons.map((option, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "icons-item"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: "{ option.link }",
    className: "icons-item__icon",
    target: "_blank"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: option.image ? option.image.url : '',
    alt: option.image ? option.image.alt : option.title
  }))))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/subscribe/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/subscribe/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/subscribe/block.json");
/**
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/subscribe","version":"0.1.0","title":"Subscribe","category":"widgets","icon":"admin-generic","description":"Subscribe block.","example":{},"supports":{"html":false,"customClassName":true,"spacing":{"padding":["top","bottom"]}},"textdomain":"subscribe","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js","attributes":{"style":{"type":"object","default":{"spacing":{"padding":{"top":"96px","bottom":"96px"}}}},"backgroundImage":{"type":"object","default":"","attributes":{"url":{"type":"string","default":""},"id":{"type":"number","default":0},"alt":{"type":"string","default":""}}},"formEmbed":{"type":"string","default":""},"title":{"type":"string","default":""},"titleLevel":{"type":"string","default":"h2"},"text":{"type":"string","default":""},"textLevel":{"type":"string","default":"p"},"socialIcons":{"type":"array","default":""},"primaryButton":{"type":"object","default":"","attributes":{"text":{"type":"string","default":""},"url":{"type":"string","default":""},"icon":{"type":"string","default":""},"target":{"type":"string","default":""}}},"secondaryButton":{"type":"object","default":"","attributes":{"text":{"type":"string","default":""},"url":{"type":"string","default":""},"icon":{"type":"string","default":""},"target":{"type":"string","default":""}}},"blockID":{"type":"string","default":""}}}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/subscribe/index": 0,
/******/ 			"blocks/subscribe/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/subscribe/style-index"], () => (__webpack_require__("./src/blocks/subscribe/index.js")))
