	...
	return (
		<div { ...blockProps } style={{ 
			...
			<InspectorControls group='typography'>
				<BaseControl>
					<SelectControl
						label={ __( 'Title Level', 'homepage-banner' ) }
						value={ titleLevel }
							options={ [
							{ label: 'H1', value: 'h1' },
							{ label: 'H2', value: 'h2' },
			...
			<InspectorControls group='typography'>
				<BaseControl>
					<SelectControl
						label={ __( 'Text Level', 'homepage-banner' ) }
						value={ textLevel }
							options={ [
							{ label: 'H1', value: 'h1' },
							{ label: 'H2', value: 'h2' },
			...
			<InspectorControls>
				<PanelBody title={ __( 'Homepage Banner Settings', 'homepage-banner' ) }>
					<BaseControl>
						<MediaUpload
							onSelect={(media) => {
									...
									<Button onClick={ open }
										...
										{ backgroundImage && backgroundImage.id !== 0 ? 
											<ResponsiveWrapper>
												...
												: __( 'Select Background Image', 'homepage-banner' )
											}										
										</Button>
							)}
						/>
					</BaseControl>
					{
						backgroundImage && backgroundImage.id !== 0 && (
							<BaseControl>
								...
								>
									{ __( 'Remove Background Image', 'homepage-banner' ) }
								</Button>
							</BaseControl>
						)
					}
					<BaseControl>
						<TextControl
							label={ __( 'Title', 'homepage-banner' ) }
							value={ title }
					...
					<BaseControl>
						<TextareaControl
							label={ __( 'Text', 'homepage-banner' ) }
							value={ text }
							onChange={ ( value ) => setAttributes( { text: value } ) }
						/>
					</BaseControl>
					<BaseControl
						label={ __( 'Primary Button', 'homepage-banner' ) }
					>
						<TextControl
							label={ __( 'Text', 'homepage-banner' ) }
						...
						/>
						<TextControl
							label={ __( 'SVG Icon (Inline or URL)', 'homepage-banner' ) }
							value={ primaryButton.icon }
							onChange={ ( value ) => setAttributes( { primaryButton: { ...primaryButton, icon: value } } ) }
							help={__('Enter the SVG inline code or the URL to an external SVG file.', 'homepage-banner')}
						/>
						<MediaUploadCheck>
							<MediaUpload
								...
								render={({ open }) => (
									<Button onClick={ open } isPrimary>
										{ __( 'Upload SVG Icon', 'homepage-banner' ) }
									</Button>
								)}
							/>
						</MediaUploadCheck>
					...
					<BaseControl
						label={ __( 'Secondary Button', 'homepage-banner' ) }
					>
						<TextControl
							label={ __( 'Text', 'homepage-banner' ) }
						...
						/>
						<SelectControl
							label={ __( 'Secondary Button Target', 'homepage-banner' ) }
					...
					<TextControl
						label={ __( 'Block ID', 'homepage-banner' ) }
						value={ blockID }
						onChange={ ( value ) => setAttributes( { blockID: value } ) }
					/>
				</PanelBody>
			</InspectorControls>
			<div className={`homepage-banner__overlay`}></div>
			<div className={`homepage-banner__wrapper container`}>
				<div className={`homepage-banner__text-wrapper`}>
					<RichText
						tagName={ titleLevel }
						value={ title }
						onChange={ ( value ) => setAttributes( { title: value } ) }
					...
					/>
					<div className='homepage-banner__text-buttons'>
					{
